...
LIBVLC_API int libvlc_media_get_acestream_hls_streams_count( libvlc_media_t *p_md );
LIBVLC_API int libvlc_media_get_acestream_hls_streams_current( libvlc_media_t *p_md );
LIBVLC_API int libvlc_media_get_acestream_hls_stream_bitrate( libvlc_media_t *p_md, int stream_index );
