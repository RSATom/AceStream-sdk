...
#define CAT_ADVANCED 6
   ...
   #define SUBCAT_ADVANCED_P2P 603
   #define SUBCAT_ADVANCED_NETWORK 604
   #define SUBCAT_ADVANCED_XML 605
...
#define CAT_WEB_PLUGIN 9
	#define SUBCAT_WEB_PLUGIN_INTERFACE 901
